...
export const Logo = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <Image
            src="/Logo.png"
            alt="Logo"
            width={150}         // Increased from 500
            height={300}        // Increased from 250
            className={cn('h-12 w-auto min-w-[100px]', className)}  // Increased from h-14, added min-width
        />
    )
}
...
export const LogoIcon = ({ className, uniColor }: { className?: string; uniColor?: boolean }) => {
    return (
        <Image
            src="/Logo.png"
            alt="Logo Icon"
            width={300}         // Increased from 500
            height={150}        // Increased from 250
            className={cn('size-24 min-w-[100px] max-h-[32]', className)}  // Increased from size-16, added min-width
        />
    )
}
