                ...
                <section className="bg-muted/50 dark:bg-background overflow-hidden">
                    <div className="relative mx-auto max-w-5xl px-6 pt-28 lg:pt-24">
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">Modern Banking reimagined</h1>
                            <p className="text-muted-foreground mx-auto my-8 max-w-2xl text-xl">Team 18's exciting new portal to a whole new world of banking!</p>

                            <Button
                                asChild
                                size="lg">
                                <Link href="/dash">
                                    <span className="btn-label">Start Banking!</span>
                                </Link>
                            </Button>
                        </div>
                    </div>
